...
export class TipoProyectoService {
  ...
  /**
   * Metodo que obtiene todos los tipos de proyecto desde el servicio REST respectivo
   * @returns servicio con todos los tipos de proyecto
   */
  getTiposProyecto() {
    const endpoint = `${endpoint_url}/tiposProyecto`;
   ...
   * @param idTipoProyecto identificador unico que se utilizara para actualizar el registro
   * @returns servicio para actualizar un registro mediante su identificador unico
   */
  updateTipoProyecto(body: any, idTipoProyecto: number) {
    const endpoint = `${endpoint_url}/tiposProyecto/${idTipoProyecto}`;
   ...
   * @param idTipoProyecto identificador unico del registro a eliminar
   * @returns servicio para eliminar un registro en la base de datos
   */
  deleteTipoProyecto(idTipoProyecto: any) {
    const endpoint = `${endpoint_url}/tiposProyecto/${idTipoProyecto}`;
   ...
   */
  exportTiposProyectoExcel() {
    const endpoint = `${endpoint_url}/tiposProyecto/export/excel`;
