...
export class SitioService {
     ...
     */
    getSitios() {
        const endpoint = `${endpoint_url}/sitios`;
     ...
     * @param idSitio identificador unico que se utilizara para actualizar el registro
     * @returns servicio para actualizar un registro mediante su identificador unico
     */
    updateSitio(body: any, idSitio: any) {
        const endpoint = `${endpoint_url}/sitios/${idSitio}`;
     ...
     * @param idSitio identificador unico del registro a eliminar
     * @returns servicio para eliminar un registro en la base de datos
     */
    deleteSitio(idSitio: any) {
        const endpoint = `${endpoint_url}/sitios/${idSitio}`;
     ...
     */
    exportSitiosExcel() {
        const endpoint = `${endpoint_url}/sitios/export/excel`;
